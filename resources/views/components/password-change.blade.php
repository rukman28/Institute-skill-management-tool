@auth('sysadmin')
    <form method="POST" action="{{route('sysadmin.institutes.password_change',$institute)}}" class="max-w-sm mx-auto">
@elseif('institute')
    <form method="POST" action="{{route('institutes.password_change',$institute)}}" class="max-w-sm mx-auto">
